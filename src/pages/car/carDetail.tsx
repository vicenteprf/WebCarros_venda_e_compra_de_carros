        ...
        >
          {car?.images.map((images) => (
            <SwiperSlide key={images.name}>
              <img className="w-full h-96 object-cover" src={images.url} />
            </SwiperSlide>
          ))}
        </Swiper>
      )}
      ...
      {car && (
        <main className="w-full bg-white rounded-lg p-6 my-4">
          ...
          <a
            ...
            href={`http://api.whatsapp.com/send?phone=${car?.whatsapp}&text=Olá vi esse ${car?.name} no site WebCarros e fiquei interessado!`}
            target="_blank"
          >
